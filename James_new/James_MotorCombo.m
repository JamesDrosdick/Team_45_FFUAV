...
function D = James_MotorCombo(Combo_number)
    ...
    % Read data in table
    data = readmatrix('Acceptable_Motors3.csv','Range','A2:CH12');
    ...
    Voltage = [ data(1,72:86) ; data(i,72:86) ];
    ...
    data = readtable('Acceptable_Motors3.csv', "Delimiter", ',','Range','A3:CH12');
    i = Combo_number;
    D = struct("Motor_Name", convertCharsToStrings(data.Var1(i)), "Cost", data.Var2(i), "Weight_g", data.Var3(i), "Kv", data.Var4(i),  ...
    ...
    "Thrust_N", Thrust, "Current_A",Current, "Power_W", Power, "Rpm", Rpm, "Voltage", Voltage); 
