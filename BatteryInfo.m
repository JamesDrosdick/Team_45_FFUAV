function D = BatteryInfo(Battery_number)    
    ...
    i = Battery_number; 
        ...
        D = struct("Battery_Name", convertCharsToStrings(data.BatteryName(i)), "Battery_Cap_mAH", data.PowerCapacity_mAh_(i), "Voltage", data.Voltage_V_(i), "Energy_Wh", data.Energy_Wh_(i), "Cont_Discharge_C", data.ContinuousDischargeRate_C_(i), ...
